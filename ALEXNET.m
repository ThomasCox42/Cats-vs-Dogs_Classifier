...
%% Part 6: Training on Kaggle dataset

%% 6.1: Setting up our dataset
% load new training image data set as an image datastore
clear categories;
images = imageDatastore('./data/PetImagesKaggleTrain', 'IncludeSubfolders', true, 'LabelSource', 'foldernames');
...
%% 6.2: Setting up Alexnet
% Extract all but the last 3 layers of alexnet
...
%% 6.3: Training our CNN on the new partitioned dataset
%Set up the batchsize for training
miniBatchSize = 10;
...
% Train the network
alexnetTransfer = trainNetwork(trainingImages,layers,options);

%% 6.4: Classify the testing image dataset
